...
const getPlantMessage = (plant, adapter) => {
	return "";//adapter._("notificationPlantLightTooBright")
};

//`Plant ${plant.nickname} is too bright`,
module.exports = {
	plant: {
		light_status: [
			{
				...
				notification: {
					category: "checkPlant",
					template: (plant, adapter) => ({
						...getDefaultPlantProperties(plant),
						message: getPlantMessage(plant, adapter),
