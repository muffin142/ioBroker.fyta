...
const statesDefinition = {
	...
	plant: {
		...
		air_humidity_status: 	{ name: "air_humidity_status",	type: "number",		role: "info.status",		def: 0,		states: { 0: "No Data", 1: "Too Low", 2: "Low", 3: "Perfect", 4: "High", 5: "Too High" }, },
	...
	rawValues: {
		...
		"plant.measurements.air_humidity.values.current":				{ name: "air_humidity_current", 			type: "number", 	role: "value.humidity", 	def: 0,		convert: (value) => parseInt(value)},
		"plant.measurements.air_humidity.values.min_good":				{ name: "air_humidity_min_good", 			type: "number", 	role: "value", 				def: 0,		convert: (value) => parseInt(value)},
		"plant.measurements.air_humidity.values.max_good":				{ name: "air_humidity_max_good", 			type: "number", 	role: "value", 				def: 0,		convert: (value) => parseInt(value)},
		"plant.measurements.air_humidity.values.min_acceptable":		{ name: "air_humidity_min_acceptable", 		type: "number", 	role: "value", 				def: 0,		convert: (value) => parseInt(value)},
		"plant.measurements.air_humidity.values.max_acceptable":		{ name: "air_humidity_max_acceptable", 		type: "number", 	role: "value", 				def: 0,		convert: (value) => parseInt(value)},
		"plant.measurements.air_humidity.unit":							{ name: "air_humidity_unit", 				type: "string", 	role: "value", 				def: "",	},
